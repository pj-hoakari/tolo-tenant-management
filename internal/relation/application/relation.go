...
func NewRelationService(tenants tenantrepository.TenantRepository, memberships repository.MembershipRepository) *RelationService {
	return &RelationService{tenants: tenants, memberships: memberships}
}
